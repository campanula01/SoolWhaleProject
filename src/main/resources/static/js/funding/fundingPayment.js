$(function() {
	...
	function updateOrInsertAddress(callback) {
		...
		var requestURL = addrNum ? "/address/addressUpdate" : "/address/addressInsert";
	...
	function submitForm() {
		updateOrInsertAddress(function(addrNumFromUpdateOrInsert) {
			...
			$.ajax({
				url: "/payment/paymentInsert?projectNum=" + projectNum,
				type: "POST",
				...
				success: function(response) {
					...
					$.ajax({
						...
						success: function(pointResponse) {
							...
							$.ajax({
								url: "/payment/fundingPayComplete?projectNum=" + projectNum,
								type: "POST",
								contentType: "application/json",
								data: JSON.stringify(purchaseData),
	...
	function saveScheduledPayment(customer_uid, amount, merchant_uid, projectNum) {
		$.ajax({
			...
			type: "POST",
			url: "/payment/saveScheduledPayment",
			contentType: "application/json",
			data: JSON.stringify({
				"customer_uid": customer_uid,
				"amount": amount,
