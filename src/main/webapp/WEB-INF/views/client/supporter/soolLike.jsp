		...
		<div class="wrap_center wrap_myinfo">
			...
			<section class="main_section">
                ...
                <option value="3">진행종료</option>
					...
					<span class="like_select"> <span id="likeAll">전체</span> <span
						id="likeBefore">진행예정</span> <span id="likeIng">진행중</span> <span
						id="likeAfter">진행종료</span>
					</span>
					...
					<c:choose>
						<c:when test="${not empty likeAllList}">
							<c:forEach var="like" items="${likeAllList}" varStatus="status">
								...
								<div class="soollike_list" id="soollike_list"
									data-num="${like.likeNum}">
									<script type="text/javascript">
										$(document).ready(
												function() {
													var likeNumValue = $(
									...
									<div class="soollike_ddd">
										<ul class="soollike_ul">
											<li class="soolproject_title"><span class="likeempty">
