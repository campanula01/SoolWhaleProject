...
<body>
   <div id="wrap_header">
      <header class="flex_wrap wrap_center">
         ...
         <h1 id="logo">
            <a href="/"><img src="/resources/img/common/user_img.png" /><span
               id="logo_txt">술고래</span></a>
         </h1>
         <div id="wrap_nav">
            <nav>
               <ul>
                  <li><a href="/project/liquorList?liquorType=탁주">탁주</a></li>
                  <li><a href="/project/liquorList?liquorType=증류주">증류주</a></li>
                  <li><a href="/project/liquorList?liquorType=과실주">과실주</a></li>
                  <li><a href="/project/liquorList?liquorType=약.청주">약.청주</a></li>
            ...
            <div id="header_bnts">
               ...
               <c:choose>
                  <c:when test="${not empty login}">
                     ...
                     <a href="/supporter/likeAllList"><i class="fa-regular fa-heart"></i></a>
                     <a href="/member/myInfoMain"><i class="fa-regular fa-circle-user"></i></a>
                  </c:when>
