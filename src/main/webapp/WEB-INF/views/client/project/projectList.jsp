		...
		<div class="wrap_center wrap_myinfo">
			<aside class="main_aside" id="wrap_aside">
				...
				<div class="maker_form">
					...
					<ul class="maker_ul">
                    <li class="maker_li1 li_style" id="maker_li1"><a href="/project/projectList">내 프로젝트</a></li>
                    <li class="maker_li2 li_style" id="maker_li2"><a href="/project/projectSellingList">판매현황</a></li>
                </ul>
				</div>
											...
											<c:if test="${project.sts ne '진행중'}">
												<a href="/project/preview?projectNum=${project.projectNum}">
													<c:if test="${not empty project.firstImgFilename}">
														<img src="/resources/img/project/uploadStorage/project/${project.firstImgFilename}" class="project_thumbnail_image" />
													</c:if>
