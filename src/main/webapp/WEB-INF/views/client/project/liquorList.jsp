...
<script src="/SoolWhale/resources/js/liquor.js"></script>
...
<link rel="stylesheet" href="/SoolWhale/resources/css/funding/liquorList.css">
</head>
<body>
	<div id="wrap">
								...
								<c:forEach var="list" items="${list}" varStatus="status">
									<c:if test="${not empty list}">
										<div class="slider_div1">
											<a
												href="/SoolWhale/project/fundingDetailView?projectNum=${list.projectNum}">
												<img class="mainImage"
