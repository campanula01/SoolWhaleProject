...
<html>
  ...
  <script src="/resources/js/common/paymentDelay.js"></script>
...
<input type="hidden" name="paymentCount" class="paymentCount" value=" ${paymentComplete.paymentCount }">
    ...
    <div class="funding_complete_info">
       <div class="complete_title">
            <h2>펀딩 완료</h2>
            <img src="/resources/img/funding/fundingPayComplete.gif" alt="펀딩 완료 gif">
         </div>
    ...
    <div class="slider-wrap">
      ...
      <div class="slides">
        ...
        <a href="/project/fundingDetailView?projectNum=${project.projectNum}">
          <div class="slide">
             ${project.title }
              <img src="/resources/img/project/uploadStorage/project/${project.firstImgFilename}" alt="Image for ${project.title}" onclick="redirectToAnotherPage(this)" data-project-num="${project.projectNum}"/>
          </div>
          </a>
      </c:forEach>
      </div>
