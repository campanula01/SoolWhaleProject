...
<script type="text/javascript">
	$(function() {
		$(".acceptBtn").click(function() {
            ...
            form.attr("action", "/project/projectAccept");
        ...
        $(".refuseBtn").click(function() {
            var projectNum = $(this).data("project-num");
            var form = $("#" + projectNum + "_form");
            form.attr("action", "/project/projectRefuse");
            form.attr("method", "get");
            form.submit();
        });
                            ...
                            <c:when test="${not empty projectList}">
                                <c:forEach var="list" items="${projectList}" varStatus="status">
                                    <c:if test="${list.sts eq '심사중'}">
                                        ...
                                        <tr>
                                            <td><a href="/project/preview?projectNum=${list.projectNum}">
                                                    <img class="firstImage" src="/resources/img/project/uploadStorage/project/${list.firstImgFilename}" alt="">
                                                </a></td>
                                            <td>${list.title}</td>
