 ...
 <script type="text/javascript">
 		$(function(){
 			...
 			$("#point_info").click(function(){
 				...
 				location.href="/SoolWhale/member/pointCheck";
 			});
 			...
 			$("#support_li1").click(function(){
 				...
 				location.href="/SoolWhale/supporter/orderList";
 			})
 			$("#support_li2").click(function(){
 				console.log("관심 프로젝트 페이지 호출")
 				location.href="/SoolWhale/supporter/soolLike";
 			})
...
<body>
    ...
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <img src="/SoolWhale/resources/img/common/user_img.png" style="width: 50px; height: 50px">
