...
<head>
  ...
  <script src="/SoolWhale/resources/js/funding/fundingDetail.js"></script>
    ...
    var projectImg1 = "http://15.164.224.224:8080/home/tomcat/file/project/"+encodeURIComponent("${projectDetail.firstImgFilename}");
    var projectDesc1 = "${projectDetail.projectDesc}";

    console.log("http://15.164.224.224:8080/home/tomcat/file/project/"+encodeURIComponent("${projectDetail.firstImgFilename}"));
        ...
        Kakao.Link.sendDefault({
            ...
            content: {
                ...
                link: {
                    ...
                    webUrl: 'http://15.164.224.224:8080/SoolWhale/project/fundingDetailView?projectNum=' + projectNum1
                }
            },
        });
    }
