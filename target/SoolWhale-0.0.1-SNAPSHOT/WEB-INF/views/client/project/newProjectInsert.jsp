...
<html>
	<head>
		...
		<link rel="stylesheet" href="/SoolWhale/resources/css/project/makerInfo.css">
		...
		<script src="/SoolWhale/resources/js/project/newProjectInsert.js"></script>
	...
	<body>
		<!-- <div id="fee_popup" class="fee_popup">
        	<div class="popup-content">
            	<h2>환영합니다!</h2>
            	<p>수수료는 프로젝트 총 펀딩액의 3%입니다.</p>
            	<p>(비동의 클릭시 이전페이지로 이동합니다.)</p>
            	<div class="fee_select">
                	<form id="fee_select_form">
                    	<button id="fee_agree">동의</button>
                    	<button id="fee_disagree">비동의</button>
                	</form>
            	</div>
        	</div>
    	</div> -->
            ...
            <input type="hidden" name="userNum" value="${userNum}">
                ...
                <div class="project_title">
                    ...
                    <div class="project_title_form">
                        <h3>제목</h3>
                        <textarea class="project_title_input" name="title" id="title" maxlength="30"></textarea>
                    </div>
                </div>
                <div class="project_summary">
                    ...
                    <div class="project_summary_form">
                        <h3>요약</h3>
                        <textarea class="project_summary_input" name="projectDesc" id="projectDesc" maxlength="50"></textarea>
                    </div>
                </div>
